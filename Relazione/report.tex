...
\begin{titlepage}
    \begin{center}
 	...
 	\textit{Progetto di gruppo} \\
        \textbf{Studenti:} Cretone Manuel, Silvestri Emilio\\
        \textbf{Tutor:} Piangerelli Marco
        \vfill
...
\todo{https://www.my-personaltrainer.it/salute/epilessia.html}
...
\end{itemize}
Tutti questi passi vengono ripetuti sequenzialmente diverse volte. Una singola iterazione prende il nome di \textit{epoca}.
...
Essa è una single page application, \todo{è vero?} cioè un'applicazione web che è fruibile su una sola pagina web garantendo una fluidità maggiore nell'esperienza dell'utente.
